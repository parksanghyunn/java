...
<link rel="stylesheet" href="/resources/css/indexList.css">
<style>
.gallery{
  display: flex;
  width: 100%;
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-sm-12 col-xs-12">
					<div class="banner">
						<a href="#"><img src="/resources/images/ads.png"
						...
						<c:forEach var="b_bean" items="${boardFindList}">
							...
							<c:choose>
								<c:when test="${b_bean.BOARD_PATH eq null}">
									<td class="scale"><img src="/resources/images/bg-01.jpg" width=100px; height=100px;></td>
								</c:when>
								<c:otherwise>
				...
				<c:choose>
					<c:when test="${boardDogList != null and fn:length(boardDogList) > 0}">
						...
						<div class="gallery">
							...
							<c:choose>
								<c:when test="${b_bean.BOARD_PATH eq null}">
									<img src="/resources/images/bg-01.jpg">
								</c:when>
								<c:otherwise>
